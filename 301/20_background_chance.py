...
background = cv.imread("/Users/bahriyeisgor/Desktop/OpenCV/images/background.jpg")
...
mask2 = mask2 / 255.0
a = mask2[..., None]
result = a * (src.astype(np.float32)) + (1 - a) * (background.astype(np.float32)) #Yazdırmak istediğimiz çıkış matrisi
